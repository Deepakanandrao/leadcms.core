...
public class ErrorsController : Controller
{
    ...
    private string GetUniqueViolationMessage(string? constraintName)
    {
        return constraintName?.ToLowerInvariant() switch
        {
            ...
            "ix_redirect_from_path" => "A redirect with this path source already exists.",
            "ix_redirect_from_language_from_slug" => "A redirect with this language and slug source already exists.",
            "ix_redirect_from_content_id" => "A redirect with this content ID source already exists.",
